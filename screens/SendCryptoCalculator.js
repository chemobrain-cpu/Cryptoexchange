    ...
    let proceedHandler = async () => {
        if (action == 'SendToBank') {
            ...
            if (invert) {
                ...
                return navigation.navigate("SendToBank", data)
    ...
    return (<>
        ...
        <SafeAreaView style={{ backgroundColor: background, flex: 1 }}>
            <ScrollView contentContainerStyle={styles.scrollContainer} stickyHeaderIndices={[0]}>
                ...
                <Card style={{ ...styles.card, backgroundColor: background, borderColor: background == 'black' ? fadeColor : "#fff" }}>
