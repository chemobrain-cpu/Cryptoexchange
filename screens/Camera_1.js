...
import { uploadFrontId } from "../store/action/appStorage";
...
const CameraFun = ({ navigation }) => {
    ...
    const uploadPictureHandler = async () => {
        ...
        let res = await dispatch(uploadFrontId(imageUrl))
        setIsLoading(false)
        if (!res.bool) {
            setIsLoading(false)
            setIsAuthError(true)
    ...
    return (<>
        ...
        <SafeAreaView style={styles.screen}>
            ...
            < Pressable onPress={() => navigation.goBack()} style={styles.infoCon}>
                ...
                <Text style={styles.infoText}>Please upload photo of the front section of your driver's license or state ID </Text>
